...
const CreateProjectDialog = ({ isDialogOpen, setIsDialogOpen }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/20 dark:bg-black/60 backdrop-blur">
            <div className="min-h-full flex items-center justify-center p-4">
                <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto text-zinc-900 dark:text-zinc-200 relative text-left">
                    ...
                    <h2 className="text-xl font-medium mb-1 pr-8">Create New Project</h2>
                    {currentWorkspace && (
